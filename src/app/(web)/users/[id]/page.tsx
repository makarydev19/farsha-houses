...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  return (
    <div className="container mx-auto md:px-16 py10">
      <div className="grid md:grid-cols-12 gap-10 md:mx-0 mx-8">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <nav className="sticky top-0 px-2 w-fit md:w-full md:px-5 py-3 mb-8 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-7">
            <ol
              className={`${
