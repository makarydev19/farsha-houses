...
const FeaturedRoom: FC<Props> = (props) => {
  ...
  return (
    <section className="flex md:flex-row flex-col px-20 max-md:px-5 py-10 items-center gap-12 container mx-auto">
      ...
      <div className="md:py-10 md:w-1/2 text-left">
        <h3 className="font-heading mb-8">Featured Room</h3>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
          <div className="flex mb-3 md:mb-0">
            <div className="flex gap-3 flex-col items-center justify-center mr-10">
